{{--Tweet Model--}}
<div class="modal-insert modal fade h-auto " id="comment-{{$tweet->id}}"  tabindex="-1" aria-labelledby="comment-{{$tweet->id}}" aria-hidden="true">
            ...
            <div class="modal-body h-auto">
                <div class="comment_body d-flex flex-column">
                    <div class="d-flex flex-row mt-n2">
                        <img src="storage/default-user-image.png" alt="" class="rounded-circle ml-3" width="50px" height="50px">
                        <div class="ml-2">
                            <p class="font-weight-light mt-2 text-white">{{$tweet->user->name}}</p>
                            <p class="text-secondary comment_mail mt-n3">{{'@'.$tweet->user->name}}</p>
                        </div>
                    </div>

                    <div>
                        <div class="pl-4 pr-3 text-white font-weight-lighter"><p>{{$tweet->body}}</p></div>
                        <div class="p-3"><img src="/body.jpg" class="img-fluid  w-auto h-auto img_comment" alt=""></div>
                        <div class="text-secondary time_comment pl-4"><p>Replying to
                                <span class="text-info">@Reuters and @jeffmason1</span></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="tools d-flex flex-row  ">
                    ...
                    <form action=" " wire:submit.prevent="store" class="post-form w-100">

                        <textarea  class="addTweet  scroll border-0 pt-3 w-100 text-white"
                                   style=" resize: none;" placeholder="What's happening?"
                                   name="body" wire:model.defer="body"  ></textarea>
