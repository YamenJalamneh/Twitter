<form action="#" wire:submit.prevent="store" enctype="multipart/form-data" class="post-form w-100">
    @csrf
    ...
    <div class="d-flex flex-row justify-content-between border-top">
        <div class="d-flex flex-row justify-content-between mt-2 mb-2">
            <div class="form-group">
                ...
                <input type="file" wire:model="photo" class="d-none" id="img">
            </div>
        ...
        <div class=" mt-2">
            <button type="submit" class="  tweet-btn btn btn-primary btn-lg btn-block rounded-pill">Tweet</button>
        </div>
    </div>
</form>
